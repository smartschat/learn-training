...
- `pronunciation.html` - Audio pronunciation using Web Speech API
...
3. **Question types**: `translate` (German↔English), `choice` (multiple choice), `fill` (fill-in-blank), `order` (word ordering)
